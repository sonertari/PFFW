...
if (filter_has_var(INPUT_POST, 'Apply')) {
	...
	if ($View->Controller($Output, 'InitGraphs')) {
		PrintHelpWindow(_NOTICE('Graphs reinitialized.'), 'auto', 'INFO');
	}
	else {
		PrintHelpWindow(_NOTICE('Graphs reinitialize failed.'), 'auto', 'ERROR');
	}
}
