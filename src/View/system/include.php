...
class System extends View
{
	...
	function __construct()
	{
		...
		$this->LogsHelpMsg= _HELPWINDOW('This page shows system-wide logs. Most services on PFFW write to their own log files, but a few processes may log messages to this system file. Pay special attention to error messages.');
	}
